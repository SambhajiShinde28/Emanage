...
[![Watch the video](https://drive.google.com/uc?export=view&id=1QUMaA0S33RJGVK0BABWG1ndKWoPPcwcX)](https://drive.google.com/file/d/1lfE4JDgeSQxL6g5xUmujZtGr74eJu8ft/view?usp=sharing)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/SambhajiShinde28/Emanage.git
   cd Emanage
...
- Generating and saving custom PDF reports using ReportLab.
- Managing a full-stack project structure with CRUD operations.
