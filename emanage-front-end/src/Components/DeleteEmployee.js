...
function DeleteEmployee() {
    ...
    const receivedData = location.state?.delete;
    const [deleteData, setDeleteData] = useState([])

    useEffect(() => {
        if (receivedData) {
            setDeleteData(receivedData);
        }
    }, [receivedData]);

    useEffect(() => {
        if (deleteData && inputFieldsRef.current.length) {

            inputFieldsRef.current[0].value = deleteData.No || "";
            inputFieldsRef.current[1].value = deleteData.Person_Name || "";
            inputFieldsRef.current[2].value = deleteData.Salary || "";
            inputFieldsRef.current[3].value = deleteData.Bonus || "";
            inputFieldsRef.current[4].value = deleteData.Role || "";
            inputFieldsRef.current[5].value = deleteData.Department || "";
            inputFieldsRef.current[6].value = deleteData.Location || "";
            inputFieldsRef.current[7].value = deleteData.HireDate || "";
            inputFieldsRef.current[8].value = deleteData.Total_Absent || "";
            inputFieldsRef.current[9].value = deleteData.Current_Status || "";
    ...
    async function updateBTNClicked() {
        ...
        if (inputFieldsRef.current[0].value !== '' && inputFieldsRef.current[1].value !== '' && inputFieldsRef.current[2].value !== '' && inputFieldsRef.current[3].value !== '' && inputFieldsRef.current[4].value !== '' && inputFieldsRef.current[5].value !== '' && inputFieldsRef.current[6].value !== '' && inputFieldsRef.current[7].value !== '' && inputFieldsRef.current[8].value !== '' && inputFieldsRef.current[9].value !== '') {
            ...
            const deletedData = {data:inputFieldsRef.current[0].value}
            
            const sendData = await axios.delete("http://127.0.0.1:8000/viewemployee/deleteemployee/",{
                headers: {
            ...
            if (sendData.status === 204 && sendData.statusText === "No Content") {
        ...
        <div className="mainContainer">
            ...
            <div className="formContainer">
                ...
                <div className="formFieldsContainer">
                    ...
                    <div className="formField id">
                        <div className="formFieldContainer">
                            <input type="text" name="id-field" className="field idField" onClick={() => inputFieldClicked(0)} ref={(el) => (inputFieldsRef.current[0] = el)} />
                ...
                <div className="formSubmitBtnContainer">
                    <button type="button" id="updateBtn" onClick={updateBTNClicked}><span className="material-symbols-outlined">delete</span>Delete</button>
